(function (global) {
  ...
  loadUtil.getValidJSForWebStandardComplianceBroswer = function (
    ...
    if (__DEBUG__) {
      scriptTag.src =
        currentCdnUrl + "/v1/" + fileName + "?time=" + _getYYYYMMDDHH();
    } else {
      scriptTag.src = currentCdnUrl + "/v1/" + fileName + "?2024-03-28T05_56_07.146Z";
    }
  ...
  loadUtil.getValidJSForNonWebStandardComplianceBroswer = function (
    ...
    if (__DEBUG__) {
      scriptSrc = scriptSrc + "/v1/" + fileName + "?time=" + _getYYYYMMDDHH();
    } else {
      scriptSrc = scriptSrc + "/v1/" + fileName + "?2024-03-28T05_56_07.146Z";
    }
  ...
  function _appendKftcWebServerJs(fileName, iframeDocument, onloadFunc) {
    ...
    if (__DEBUG__) {
      kftcScriptElem.src =
        "https://4user.yeskey.or.kr/v1/" + fileName + "?time=" + _getYYYYMMDDHH();
    } else {
      kftcScriptElem.src = "https://4user.yeskey.or.kr/v1/" + fileName + "?2024-03-28T05_56_07.146Z";
    }
